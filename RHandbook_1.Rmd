...
##### Windows:
If you have a PC, you will need to install RTools. Go to the [RTools download website](https://cran.r-project.org/bin/windows/Rtools/). Unless you are running an old version of R (you probably are not, unless you installed R years ago and have not updated), select the "RTools 4.3" link. On the new page, look for the Rtools43 installer link about halfway down the page, in the Installing Rtools 43 section. Click on this link to download the exe file. Run the file and follow the onscreen instructions to complete the installation. You may use the default settings. After the installation has finished, you should be set!
